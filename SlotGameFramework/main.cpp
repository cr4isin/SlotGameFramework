...
int main(int argc, char* argv[])
{
    ...
    game.RunSims(1, 100'000'000, args, true);   // Runs a sim. First argument is number of trials, second is number of games per trial. Files output to current directory
...
// to do:
// add median spins to sim results
